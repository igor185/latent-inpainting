...
class AutoencoderTrainingModule(BaseInpaintingTrainingModule):
    ...
    def forward(self, batch):
        ...
        batch["h"] = self.generator.model[:5](masked_img)
        # batch['predicted_image'] = self.generator(masked_img)
        batch['predicted_image'] = self.generator.model[-13:](batch["h"])
