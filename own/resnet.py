...
if __name__ == "__main__":
    configs, bottleneck = get_configs("resnet101")
    ckpt = torch.load("/home/engineer/Dev/igor/thesis/own/caltech256 resnet101.pth", map_location="cpu")
    ...
    img = np.array(PIL.Image.open("/home/engineer/Dev/igor/thesis/own/data/image.png").resize((512, 512)))
    ...
    print((input - output).abs().mean())

    img_out = output.squeeze(0).permute(1, 2, 0).detach().numpy()
